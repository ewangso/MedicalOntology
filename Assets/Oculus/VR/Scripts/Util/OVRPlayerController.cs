...
public class OVRPlayerController : MonoBehaviour
{
    ...
    //private bool secondButtonPressed = false;
    //private float flyButtonPressedTime = -1;
    void Start()
	{
		// Add eye-depth as a camera offset from the player controller
		var p = CameraRig.transform.localPosition;
        Debug.Log("Camera Rig Position: " + CameraRig.transform.localPosition);
	...
	public virtual void UpdateMovement()
	{
		...
		if (EnableLinearMovement)
		{
            ...
            bool moveUp = Input.GetKey(KeyCode.P);
			...
			/*
            if (OVRInput.GetDown(OVRInput.Button.PrimaryHandTrigger) && fly == true){
                GravityModifier = 1;
            }
            */
